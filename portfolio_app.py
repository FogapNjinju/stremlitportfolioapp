...
# Theme Persistence
if "theme" not in st.session_state:import streamlit as st
import plotly.express as px
import pandas as pd
from streamlit.runtime.media_file_storage import MediaFileStorageError
...
with st.sidebar:
    ...
    if theme == "Light":
        ...
        .stTextInput input, .stTextArea textarea { border-radius: 5px; border: 1px solid #3498db; background-color: #fff; }
        ...
        .stButton>button { background-color: #e67e22; color: white; border-radius: 5px; border: none; padding: 8px 15px; }
        .stButton>button:hover { background-color: #d35400; }
        .stTextInput input, .stTextArea textarea { border-radius: 5px; border: 1px solid #3498db; background-color: #ecf0f1; }
        a { color: #e74c3c; text-decoration: none; }
        a:hover { color: #c0392b; text-decoration: underline; }
        ...
        .stTextInput input, .stTextArea textarea { border-radius: 5px; border: 1px solid #fff; background-color: #333; color: #fff; }
