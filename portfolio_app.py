...
# Footer
st.markdown("---")
st.markdown("<p style='text-align: center; color: #7f8c8d;'>© 2025 Njinju Zilefac Fogap | Built with Streamlit</p>", unsafe_allow_html=True) in the section of experience and project can you show and indication that shows complete and in progres for each project, use nice professional design 
